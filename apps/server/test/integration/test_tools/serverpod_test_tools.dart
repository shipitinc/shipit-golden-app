...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:shipit_golden_server/src/generated/household.dart' as _i5;
...
class TestEndpoints {
  ...
  late final _ProgramsEndpoint programs;
}
...
class _HouseholdEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.HouseholdMember>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i6.HouseholdMember> addMember(
    _i1.TestSessionBuilder sessionBuilder,
    String name,
    String email,
  ) async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.HouseholdMember>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
